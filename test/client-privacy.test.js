...
test('installable userscript declares and uses the shared public-channel policy', () => {
  ...
  assert.match(source, /@require\s+https:\/\/raw\.githubusercontent\.com\/R4G3RUNN3R\/torn-revive-chat-collector\/main\/src\/public-channels\.js/);
  assert.match(source, /@require\s+https:\/\/raw\.githubusercontent\.com\/R4G3RUNN3R\/torn-revive-chat-collector\/main\/src\/client-chat-policy\.js/);
